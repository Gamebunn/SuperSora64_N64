...
extern const BehaviorScript bhvToadMessageKnux[];
extern const BehaviorScript bhvToadMessageCrem[];
extern const BehaviorScript bhvBobombBuddyTails[];
extern const BehaviorScript bhvTailsOpensCannon[];
extern const BehaviorScript bhvKoopaMetal[];
