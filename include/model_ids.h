...
// Additional common0 Models

#define MODEL_TAILS 0xFF    // tails_geo           
#define MODEL_WISP1 0xFE    // wisp1_geo
#define MODEL_MASTEREMERALD 0xFD    // masteremerald_geo  
...
#define MODEL_TIKAL                       0x56        // tikal_geo
#define MODEL_SHADOW                      0x57        // shadow_geo
...
#define MODEL_METALSONIC                  0x6C        // metalsonic_geo

// group 15
#define MODEL_MIPS                        0x64        // mips_geo
#define MODEL_BOO_CASTLE                  0x65        // boo_castle_geo
#define MODEL_LAKITU                      0x66        // lakitu_geo
#define MODEL_KNUCKLES                    0x67        // knuckles_geo
#define MODEL_CHAOSCHAO                   0x68        // chaoschao_geo
#define MODEL_TOADANGY                    0x69        // toadangy_geo
#define MODEL_CREAM                       0x6A        // cream_geo
#define MODEL_CHEESE                      0x6B        // cheese_geo
