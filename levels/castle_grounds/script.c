...
static const LevelScript script_func_local_4[] = {
    ...
    OBJECT(/*model*/ MODEL_SHADOW,     /*pos*/     0, 3174, -5625, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvYoshi),
    RETURN(),
};
...
const LevelScript level_castle_grounds_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_SHADOW, shadow_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TIKAL, tikal_geo),
