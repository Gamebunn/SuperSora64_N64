...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_TAILS,             /*pos*/ -1956,  1331,  6500, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTailsOpensCannon, /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    RETURN(),
};
...
const LevelScript level_jrb_entry[] = {
    ...
    AREA(/*index*/ 1, jrb_geo_000A18),
        ...
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0003, /*seq*/ SEQ_NEWJRB),
