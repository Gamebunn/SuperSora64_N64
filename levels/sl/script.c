...
const LevelScript level_sl_entry[] = {
    ...
    AREA(/*index*/ 1, sl_geo_0003A8),
        ...
        OBJECT(/*model*/ MODEL_WISP1, /*pos*/  4044,  1024,  98, /*angle*/ 0, 90, 0, /*behParam*/ MWISP_SL << 16, /*beh*/ bhvWisp1),
    ...
    AREA(/*index*/ 2, sl_geo_000484),
        ...
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0004, /*seq*/ SEQ_LEVEL_SLIDE),
        TERRAIN_TYPE(/*terrainType*/ TERRAIN_SNOW),
    END_AREA(),
