...
static const LevelScript script_func_local_3[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_TAILS,      /*pos*/ -1700, 1140,  3500, /*angle*/ 0,    0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTailsOpensCannon, /*acts*/ ACT_3 | ACT_4 | ACT_5 | ACT_6),
...
const LevelScript level_wf_entry[] = {
    ...
    AREA(/*index*/ 1, wf_geo_000BF8),
        ...
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0005, /*seq*/ SEQ_NEWWF),
