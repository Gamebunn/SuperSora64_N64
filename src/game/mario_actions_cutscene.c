...
static void end_peach_cutscene_mario_landing(struct MarioState *m) {
    ...
    if (is_anim_at_end(m)) {
        ...
        sEndJumboStarObj = spawn_object_abs_with_rot(gCurrentObject, 0, MODEL_MASTEREMERALD, bhvStaticObject, 0,
                                                     2528, -1800, 0, 0, 0);
...
static void end_peach_cutscene_spawn_peach(struct MarioState *m) {
    ...
    if (m->actionTimer == 40) {
        ...
        sEndPeachObj = spawn_object_abs_with_rot(gCurrentObject, 0, MODEL_TIKAL, bhvEndPeach, 0, 2428,
                                                 -1300, 0, 0, 0);
...
static s32 act_end_waving_cutscene(struct MarioState *m) {
    if (m->actionState == 0) {
        ...
        sEndPeachObj = spawn_object_abs_with_rot(gCurrentObject, 0, MODEL_TIKAL, bhvEndPeach, 60, 906,
                                                 -1180, 0, 0, 0);
