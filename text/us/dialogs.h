...
Guess what, Sonic Heroes,\n\
I've finally developed the\n\
ult. weapon! In 3 days,\n\
...
Press [Z] while running\n\
fast to do a Spin\n\
attack. To jump while\n\
rolling, press [A] or [B]."))
...
//Music Credits, hmc
DEFINE_DIALOG(MWISP_HMC, 1, 5, 30, 200, _("\
Music used:\n\
-Sonic Adventure-\n\
Dilapidated Way - \n\
Casinopolis\n\
...
//Music Credits, sl
DEFINE_DIALOG(MWISP_SL, 1, 4, 30, 200, _("\
Music used:\n\
-Sonic 3D Blast-\n\
Diamond Dust Act 2\n\
-- Sega Genesis"))
...
//Music Credits, ttm
DEFINE_DIALOG(MWISP_TTM, 1, 6, 30, 200, _("\
Music used:\n\
Main Area: \n\
-Sonic Adventure-\n\
Symbol of Thrill \n\
...
//Music Credits, ttc
DEFINE_DIALOG(MWISP_TTC, 1, 4, 30, 200, _("\
Music used:\n\
-Sonic Unleashed-\n\
Rooftop Run - Night\n\
-- 360-PS3"))
...
//Music Credits, rr
DEFINE_DIALOG(MWISP_RR, 1, 4, 30, 200, _("\
Music used:\n\
-Sonic Lost World-\n\
Sky Road Act 1\n\
-- Wii U"))
