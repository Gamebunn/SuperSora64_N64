...
#include "tikal/model.inc.c"
#include "shadow/model.inc.c"
#include "shadow/anims/data.inc.c"
#include "shadow/anims/table.inc.c"
#include "tikal/anims/data.inc.c"
#include "tikal/anims/table.inc.c"